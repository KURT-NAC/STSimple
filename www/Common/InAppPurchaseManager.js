...
/**
 * Complete an in-app purchase.
 *
 * @param {String} transactionId The transaction identifier
 */

InAppPurchaseManager.prototype.finishTransaction = function(transactionId) {
    return cordova.exec('InAppPurchaseManager.finishTransaction', transactionId);
}
